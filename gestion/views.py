...
def index(request):
    Ultimos5Coches = Coches.objects.order_by('-fecha_entrada')#Devuelve los coches ordenados por fecha de entrada, del mas nuevo al mas viejo (sin el - seria del mas viejo al mas nuevo)
